...
const PortfolioSection = () => {
  return <section dir="rtl" className="real-estate-section bg-real-estate-gray bg-white">
    <div className="real-estate-container">
      ...
      <div>
        <img src={import.meta.env.BASE_URL + "lovable-uploads/edea60fc-618b-4338-8951-05929b638142.png"} alt="فرص الاستثمارية محزية لأرضك" className="w-full rounded-xl shadow-lg" />
      </div>
    </div>
  </section>;
};
