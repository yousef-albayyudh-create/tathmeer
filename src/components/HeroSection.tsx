  ...
  return <section dir="rtl" className="real-estate-section bg-real-estate-gray bg-white">
    <div className="real-estate-container">
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-lg mb-8">
        <img src={import.meta.env.BASE_URL + "lovable-uploads/2d27575c-d03e-45cb-acd3-a673bbf58515.png"} alt="مناظر المدينة الحديثة" className="w-full h-[500px] object-cover" />
